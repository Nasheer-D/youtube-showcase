...
Displays the active large video with high resolution video thumbnail navigation at the bottom. Videos are paged after every 8th video. For small size devices with screen size less than 768px, thumbnail navigation is replaced with two large size PREV and NEXT icons.
...
* Copy the "utube-scase" folder into the /wp-content/plugins directory of your WordPress installation.
* Login to your website and go to the Plugins section of your admin panel.
